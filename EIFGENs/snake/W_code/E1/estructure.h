...
struct eif_ex_847 {union overhead overhead; char data [8];};
struct eif_ex_852 {union overhead overhead; char data [8];};
struct eif_ex_856 {union overhead overhead; char data [8];};
struct eif_ex_860 {union overhead overhead; char data [8];};
struct eif_ex_864 {union overhead overhead; char data [8];};
struct eif_ex_868 {union overhead overhead; char data [8];};
